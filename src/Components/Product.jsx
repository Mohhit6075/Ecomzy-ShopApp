...
const Product = ({ product }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-between bg-white hover:scale-[1.02] transition-all duration-200  ease-in gap-3 p-4 mt-10 ml-5 rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] hover:shadow-[0px_0px_20px_20px_#00000010] ">
      <div>
      ...
      <div className="flex">
        <HalfRating value={product.rating.rate} count={product.rating.count} />
      </div>
    </div>
  );
};
